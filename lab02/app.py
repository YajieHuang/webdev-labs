...
#########################
current_user = CurrentUser(first_name='Roxanne', last_name='Huang', email='yajiehuang2021@u.northwestern.edu', username='roxannejx')
...
@app.route('/')
def exercise1():
    return 'Hi ' + current_user.get_full_name() + " ⭐️!!"
